...
black, blue, green1, green2, green3, green, cyan, red, magenta, yellow, white, brown1, brown2, brown3, brown4 :: Colour
...
yellow  = (1.0, 1.0, 0)
white   = (1.0, 1.0, 1.0)
brown1  = (0.36, 0.25, 0.2)
brown2  = (0.55, 0.3, 0.22)
brown3  = (0.55, 0.41, 0.08)
brown4  = (0.55, 0.44, 0)
